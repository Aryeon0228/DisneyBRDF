...
export const SOURCES={
 ...
 moon:{name:'달빛',image:'moon',kind:'ambient',lux:.2,color:[1,1,1],condition:'보름달 · 지면의 예시 조도',note:'보름달 아래 약 0.1–0.3 lx 중 0.2 lx를 선택했습니다. 달의 고도·날씨에 따라 달라집니다.'},
...
export function validateSettings(input){
 ...
 const allowed=['leftSource','rightSource','leftDistance','rightDistance','leftCount','rightCount','leftLux','rightLux','mode','exposureStops','reflectancePercent','showColor'];
